...
class SVM_Class:
    ...
    def matrix(self, svm_model,feat_valid,feat_test):
    ...
    def fitEvaluateSVC(self, path_to_store_svm_model):
    ...
    def loadModelTensor(self, path):
        model.load_weights(path)
        model.summary()

    def loadModelSK(self, path):
