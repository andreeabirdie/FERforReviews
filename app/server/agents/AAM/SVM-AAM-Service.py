...
class SVM_AAM_Service:
    ...
    def __init__(self):
        ...
        self.path_to_my_picture = "C:\\Users\\Catalin\\Desktop\\facultate\\Semestru_5\\MIRPR\\laborator\\aplicatie-git\\New folder\\mirpr-calculafectiv\\app\\server\\agents\\test_images\\picture2.jpg"
        ...
        self.path_to_bd = "C:\\Users\\Catalin\\Desktop\\facultate\\licenta\\DB\\db.csv"
    ...
    def trainSVM(self):
        x_train, y_train, x_valid, y_valid, x_test, y_test, Y_train, Y_valid, Y_test = self.processData2(self.path_to_bd)
        feat_x_train, feat_y_train, feat_x_valid, feat_y_valid, feat_x_test, feat_y_test = self.prepare_features(x_train, x_valid, x_test, y_train, y_valid, y_test)

        self.svmModel = self.fitEvaluateSVC(self.path_to_store_svm_model, feat_x_train, feat_x_valid, feat_x_test, feat_y_train, feat_y_valid, feat_y_test)
